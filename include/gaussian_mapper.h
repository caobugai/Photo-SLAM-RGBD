...
protected:
    ...
    void recordKeyframeRenderedRGBDepth(
        torch::Tensor &rendered,
        torch::Tensor &ground_truth,
    ...
    void renderAndRecordKeyframe(
        ...
        std::filesystem::path result_loss_dir,
        std::string name_suffix = "");
    void renderAndRecordKeyframeRGBDepth(
        std::shared_ptr<GaussianKeyframe> pkf,
        float &dssim,
        float &psnr,
        float &psnr_gs,
...
protected:
    ...
    bool record_rendered_depth_image_;
    bool record_ground_truth_depth_image_;
